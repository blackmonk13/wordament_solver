...
def find_words(puzzle: Puzzle, trie: Trie) -> List[Tuple[str, int, List[Tuple[int, int]]]]:
    ...
    """
    def dfs(row: int, col: int, word: str, visited: Set[Tuple[int, int]], prefix: str, suffix: str, path: List[Tuple[int, int]], score: int) -> None:
        cell = puzzle[row, col]
